...
class OptionalTestCase(TestCase):
    def test_optional(self):
        ...
        self.assertEqual(
            TestParsers.b.parse(" c "), Failure("Expected r'\\d+' but found 'c'\nLine 1, character 2\n\n c \n ^ ")
        )
...
class SequentialTestCase(TestCase):
    def test_sequential(self):
        ...
        self.assertEqual(
            TestParsers.hello_world.parse("Hello David"),
    ...
    def test_multiline(self):
        ...
        self.assertEqual(
            TestParsers.hello_world.parse("Hello\nDavid"),
            Failure("Expected 'world' but found 'David'\nLine 2, character 1\n\nDavid\n^    "),
        )
